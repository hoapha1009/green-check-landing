...
export function Button({
  ...
  if (props.outline || props.light) {
    buttonClass = props.outline ? "btn-outline" : "btn-light";
  ...
  else if (props.hoverPrimary) buttonHover = "hover-primary";
  ...
  else if (props.textWhite) buttonText = "is-white";
  ...
  return props.href ? (
    <Link href={props.href}>
      <a
        ...
        data-tooltip-body={props.tooltipAppend == "document" ? "true" : ""}
      >
        {Children}
      </a>
    </Link>
